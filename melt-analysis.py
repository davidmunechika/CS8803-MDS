...
def compute_metrics(directory):
    ...
    return accuracy, average_precision, average_recall, f1_score

directories = ["melt_1000_lower", "melt_1000_upper", "melt_1000_lower_column", "melt_1000_upper_column"]

for directory in directories:
    accuracy, average_precision, average_recall, f1_score = compute_metrics(directory)
    print(f"Accuracy for {directory}: {accuracy}")
    print(f"Average precision for {directory}: {average_precision}")
    print(f"Average recall for {directory}: {average_recall}")
    print(f"F1 score for {directory}: {f1_score}")